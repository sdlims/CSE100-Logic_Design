...
HD_PWD='C:/Users/sdli/Downloads/Lab02-1.xpr/Lab02/Lab02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mod.tcl -notrace
